...
### Model Artifacts
The trained model files (`clf_rf.pkl`, `clf_xgb.pkl`, `scaler.pkl`) are provided for demonstration purposes. If you use these models in your own work, please cite this repository and acknowledge the NHANES dataset.
